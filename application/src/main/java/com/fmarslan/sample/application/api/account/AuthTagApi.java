...
import com.fmarslan.sample.service.account.AuthTagService;
import com.fmarslan.spring.application.AbstractApi;

@Repository("/api/user")
public class AuthTagApi extends AbstractApi<Long, AuthTagDto> {

	@Autowired
	AuthTagService service;

	@Override
	protected AuthTagService getService() {
		return service;
	}
